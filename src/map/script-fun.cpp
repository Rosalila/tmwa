...
static
void builtin_dogeTip(ScriptState *st)
{
...
static
void builtin_dogeDeposit(ScriptState *st)
{
    script_data& scrd = AARG(0);
    SIR reg = scrd.get_if<ScriptDataVariable>()->reg;
...
static
void builtin_dogeBalance(ScriptState *st)
{
    script_data& scrd = AARG(0);
    SIR reg = scrd.get_if<ScriptDataVariable>()->reg;
...
static
void builtin_dogeWithdraw(ScriptState *st)
{
    script_data& scrd = AARG(0);
    SIR reg = scrd.get_if<ScriptDataVariable>()->reg;
